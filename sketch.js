...
function handleComputerArrowCollision() {
  ...
  for (var j=0;j<computerArrows.length;j++) {
    var base2Collision = Matter.SAT.collides (computerArrows[j].body,playerBase.body);
    var archer2Collision = Matter.SAT.collides(computerArrows[j].body, playerArcher.body);
    var player2Collision = Matter.SAT.collides(computerArrows[j].body, player.body);
    if (base2Collision.collided||archer2Collision.collided||player2Collision.collided ) {
